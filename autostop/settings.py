"""
Django settings for autostop project.
...
SECRET_KEY = '=o=qg#-+*(z+7lb+tu$aqu(%=_xmzs1(-kby!-9ugb-pmdy-bs'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'autostop',                      # Or path to database file if using sqlite3.
...
LOGGING = {
    ...
    'handlers': {
        ...
        'log_file':{
            ...
            'filename': '/var/log/auto/debug.log',
